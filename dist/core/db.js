...
exports.db = new Database(DB_PATH);
...
function ensureUser(uid, username, firstName) {
    exports.db.prepare(`
...
function getUserApiKey(uid, provider) {
    const row = exports.db.prepare('SELECT api_key FROM user_api_keys WHERE uid=? AND provider=?').get(uid, provider);
    return row?.api_key || null;
}
function setUserApiKey(uid, provider, key) {
    exports.db.prepare(`
